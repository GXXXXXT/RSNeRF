...
class MeshExtractor:
    ...
    @ torch.no_grad()
    def create_mesh(self, decoder, map_states, voxel_size, voxels, frame_poses=None, depth_maps=None,
                    clean_mseh=False, require_color=False, offset=-10, res=8):
        ...
        if require_color:
            ...
            for points in batch_points:
                ...
                # get color
                if len(points) > 0:
                    color = eval_points(decoder, map_states, points, index, voxel_size).cuda()
